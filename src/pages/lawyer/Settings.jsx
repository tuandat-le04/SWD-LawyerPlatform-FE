...
export default function LawyerSettings() {
    ...
    const profileValidationSchema = Yup.object({
        ...
        hourlyRate: Yup.number()
            .required("Phí tư vấn theo giờ là bắt buộc")
            .min(0, "Phí tư vấn phải lớn hơn 0"),
        consultationFee: Yup.number()
            .required("Phí tư vấn ban đầu là bắt buộc")
            .min(0, "Phí tư vấn phải lớn hơn 0"),
        bio: Yup.string()
                ...
                <Form className="space-y-6">
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400">{values.specialization}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <ErrorMessage
                                ...
                                className="text-red-400 text-sm mt-1"
                            />
                            <p className="text-gray-500 text-xs mt-1">Nhập 10 chữ số (ví dụ: 0901234567)</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">
                                Chuyên môn <span className="text-red-400">*</span>
                            </label>
                            <div className="relative">
                                ...
                                <Field
                                    name="specialization"
                                    type="text"
                                    className={`w-full bg-gray-800 border rounded-lg pl-10 pr-4 py-2 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.specialization && touched.specialization
                                            ? 'border-red-500'
                                            : 'border-gray-700'
                                        }`}
                                />
                        ...
                        <div>
                            ...
                            <Field
                                name="experience"
                                type="text"
                                className={`w-full bg-gray-800 border rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.experience && touched.experience
                                        ? 'border-red-500'
                                        : 'border-gray-700'
                                    }`}
                            />
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">
                                Phí tư vấn (VNĐ/giờ) <span className="text-red-400">*</span>
                            </label>
                            <div className="relative">
                                ...
                                <Field
                                    name="hourlyRate"
                                    type="number"
                                    className={`w-full bg-gray-800 border rounded-lg pl-10 pr-4 py-2 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.hourlyRate && touched.hourlyRate
                                            ? 'border-red-500'
                                            : 'border-gray-700'
                                        }`}
                                />
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">
                                Phí tư vấn ban đầu (VNĐ) <span className="text-red-400">*</span>
                            </label>
                            <div className="relative">
                                <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
                                <Field
                                    ...
                                    type="number"
                                    className={`w-full bg-gray-800 border rounded-lg pl-10 pr-4 py-2 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.consultationFee && touched.consultationFee
                                            ? 'border-red-500'
                                            : 'border-gray-700'
                                        }`}
                                />
                    ...
                    <div>
                        ...
                        <Field
                            ...
                            as="textarea"
                            rows={4}
                            className={`w-full bg-gray-800 border rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.bio && touched.bio
                                    ? 'border-red-500'
                                    : 'border-gray-700'
                                }`}
