...
import { Scale, Calendar, Users, FileText, MessageCircle, Star, ChevronRight, Phone, Mail, MapPin, Clock, Shield, Award, Search, User, Menu, X, Building, Gavel, Heart, Briefcase, CreditCard, Monitor } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button className="bg-amber-500 text-gray-900 px-8 py-4 rounded-xl hover:bg-amber-600 transition-all duration-300 transform hover:scale-105 shadow-2xl font-semibold">
                        ...
                        {[
                            {
                                ...
                                description: "Cung cấp tư vấn pháp lý chuyên sâu về giao dịch bất động sản, hợp đồng thuê, quy hoạch và sử dụng đất để bảo vệ đầu tư của bạn."
                            },
                            {
                                icon: Gavel,
                                title: "Luật Hình Sự",
                                description: "Bảo vệ quyền lợi và tự do của bạn với hỗ trợ pháp lý toàn diện trong các vụ án hình sự, điều tra và xét xử."
                            },
                            {
                                icon: Heart,
                                title: "Luật Hôn Nhân",
                                description: "Hỗ trợ pháp lý tận tâm cho nạn nhân bạo lực gia đình, bao gồm các lệnh bảo vệ và các vấn đề pháp lý về gia đình."
                            },
                            {
                                icon: Briefcase,
                                title: "Luật Doanh Nghiệp",
                                description: "Tư vấn doanh nghiệp về thành lập công ty, hợp đồng, sáp nhập, tuân thủ và giải quyết tranh chấp để đảm bảo hoạt động suôn sẻ."
                            },
                            {
                                icon: CreditCard,
                                title: "Giải Quyết Tài Chính",
                                description: "Xử lý các thương lượng và giải quyết tài chính phức tạp, bao gồm xử lý nợ, yêu cầu bảo hiểm và các vụ bồi thường."
                            },
                            {
                                icon: Monitor,
                                title: "Dịch vụ khác",
                                description: "Đáp ứng nhu cầu pháp lý đa dạng của bạn với các dịch vụ khác như tư vấn di chúc, thừa kế, và các vấn đề pháp lý cá nhân."
                            }
                        ].map((service, index) => (
                            <div key={index} className="group p-8 rounded-2xl bg-gray-800/50 border border-gray-700 hover:border-amber-500/50 hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        <div className="text-white">
                            ...
                            <div className="text-amber-400 text-lg font-semibold mb-2">Năm kinh nghiệm</div>
                        </div>
                        <div className="text-white">
                            <div className="text-6xl md:text-7xl font-bold mb-4 text-white">
                                2,456
                            </div>
                            <div className="text-amber-400 text-lg font-semibold mb-2">Khách hàng hài lòng</div>
                        </div>
                        <div className="text-white">
                            <div className="text-6xl md:text-7xl font-bold mb-4 text-white">
                                25
                            </div>
                            <div className="text-amber-400 text-lg font-semibold mb-2">Giải thưởng lớn nhỏ</div>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        {[
                            {
                                name: "VINCENZO",
                                title: "Luật Bất Động Sản",
                                description: "Chuyên gia tư vấn pháp lý về giao dịch bất động sản với hơn 10 năm kinh nghiệm.",
                                image: "../src/assets/images/vincenzo.jpg"
                            },
                            {
                                name: "SOFIA",
                                title: "Luật Hôn Nhân",
                                description: "Luật sư chuyên nghiệp trong lĩnh vực hôn nhân gia đình và bảo vệ quyền lợi phụ nữ trẻ em.",
                                image: "../src/assets/images/sofia.jpg"
                            },
                            {
                                name: "JOHN",
                                title: "Luật Doanh Nghiệp",
                                description: "Tư vấn doanh nghiệp hàng đầu với chuyên môn sâu về thành lập và vận hành công ty.",
                            ...
                            <div key={index} className="group p-8 rounded-2xl bg-gray-800/50 border border-gray-700 hover:border-amber-500/50 hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-2">
                                ...
                                <h4 className="text-xl font-semibold text-white mb-3 group-hover:text-amber-500 transition-colors duration-300">{member.name}</h4>
                                <p className="text-amber-500 font-medium mb-3">{member.title}</p>
                                <p className="text-gray-400 leading-relaxed mb-4 text-sm">{member.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
