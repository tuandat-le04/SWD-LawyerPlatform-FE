          ...
          <section className="relative py-20 bg-gray-800/30">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h3 className="text-4xl font-bold text-white mb-4">Văn phòng của chúng tôi</h3>
                <p className="text-gray-400 text-lg">3 chi nhánh phục vụ toàn quốc</p>
              </div>
                    ...
                    <div key={office.id} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                      ...
                      <div className="relative">
                        <img
                          ...
                          alt={office.name}
                          className="w-full h-80 object-cover rounded-3xl border border-gray-700"
                        />
                      ...
                      <div className="space-y-8">
                        <div>
                          <h4 className="text-3xl font-bold text-white mb-2">{office.name}</h4>
                          <p className="text-amber-400 font-medium">Trưởng văn phòng: {office.manager}</p>
                        </div>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-gray-400 text-sm whitespace-pre-line">{office.hours}</p>
                              </div>
                            </div>

                            <div>
                              <p className="text-white font-medium mb-2">Chuyên môn chính</p>
                              <div className="flex flex-wrap gap-2">
                                {office.specialties.map((specialty, index) => (
                                  <span
                                    key={index}
                                    className="bg-amber-500/10 text-amber-400 text-xs px-3 py-1 rounded-full border border-amber-500/20"
                                  >
                                    {specialty}
                                  </span>
                                ))}
                        ...
                        <div className="flex gap-4">
                          <button
                            ...
                            className="flex-1 px-6 py-3 border border-amber-500 text-amber-400 rounded-xl hover:bg-amber-500/10 transition-all duration-300 font-medium"
                          >
                            Xem chỉ đường
                          </button>
                          <button className="flex-1 px-6 py-3 bg-amber-500 text-gray-900 rounded-xl hover:bg-amber-600 transition-all duration-300 font-medium">
                            Đặt lịch hẹn
                          </button>
                        </div>
                      </div>
